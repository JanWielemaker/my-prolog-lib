...
bench_mark(freeze, 100, A1 = 1, freeze_dummy(1, _)) :-
   freeze(A1, A2 is A1+1),
   freeze(A2, A3 is A2+1),
   freeze(A3, A4 is A3+1),
   freeze(A4, A5 is A4+1),
   freeze(A5, A6 is A5+1),
   freeze(A6, A7 is A6+1),
   freeze(A7, A8 is A7+1),
   freeze(A8, A9 is A8+1),
   freeze(A9, A10 is A9+1),
   freeze(A10, A11 is A10+1),
   freeze(A11, A12 is A11+1),
   freeze(A12, A13 is A12+1),
   freeze(A13, A14 is A13+1),
   freeze(A14, A15 is A14+1),
   freeze(A15, A16 is A15+1),
   freeze(A16, A17 is A16+1),
   freeze(A17, A18 is A17+1),
   freeze(A18, A19 is A18+1),
   freeze(A19, A20 is A19+1),
   freeze(A20, A21 is A20+1),
   freeze(A21, A22 is A21+1),
   freeze(A22, A23 is A22+1),
   freeze(A23, A24 is A23+1),
   freeze(A24, A25 is A24+1),
   freeze(A25, A26 is A25+1),
   freeze(A26, A27 is A26+1),
   freeze(A27, A28 is A27+1),
   freeze(A28, A29 is A28+1),
   freeze(A29, A30 is A29+1),
   freeze(A30, A31 is A30+1),
   freeze(A31, A32 is A31+1),
   freeze(A32, A33 is A32+1),
   freeze(A33, A34 is A33+1),
   freeze(A34, A35 is A34+1),
   freeze(A35, A36 is A35+1),
   freeze(A36, A37 is A36+1),
   freeze(A37, A38 is A37+1),
   freeze(A38, A39 is A38+1),
   freeze(A39, A40 is A39+1),
   freeze(A40, A41 is A40+1),
   freeze(A41, A42 is A41+1),
   freeze(A42, A43 is A42+1),
   freeze(A43, A44 is A43+1),
   freeze(A44, A45 is A44+1),
   freeze(A45, A46 is A45+1),
   freeze(A46, A47 is A46+1),
   freeze(A47, A48 is A47+1),
   freeze(A48, A49 is A48+1),
   freeze(A49, A50 is A49+1),
   freeze(A50, A51 is A50+1),
   freeze(A51, A52 is A51+1),
   freeze(A52, A53 is A52+1),
   freeze(A53, A54 is A53+1),
   freeze(A54, A55 is A54+1),
   freeze(A55, A56 is A55+1),
   freeze(A56, A57 is A56+1),
   freeze(A57, A58 is A57+1),
   freeze(A58, A59 is A58+1),
   freeze(A59, A60 is A59+1),
   freeze(A60, A61 is A60+1),
   freeze(A61, A62 is A61+1),
   freeze(A62, A63 is A62+1),
   freeze(A63, A64 is A63+1),
   freeze(A64, A65 is A64+1),
   freeze(A65, A66 is A65+1),
   freeze(A66, A67 is A66+1),
   freeze(A67, A68 is A67+1),
   freeze(A68, A69 is A68+1),
   freeze(A69, A70 is A69+1),
   freeze(A70, A71 is A70+1),
   freeze(A71, A72 is A71+1),
   freeze(A72, A73 is A72+1),
   freeze(A73, A74 is A73+1),
   freeze(A74, A75 is A74+1),
   freeze(A75, A76 is A75+1),
   freeze(A76, A77 is A76+1),
   freeze(A77, A78 is A77+1),
   freeze(A78, A79 is A78+1),
   freeze(A79, A80 is A79+1),
   freeze(A80, A81 is A80+1),
   freeze(A81, A82 is A81+1),
   freeze(A82, A83 is A82+1),
   freeze(A83, A84 is A83+1),
   freeze(A84, A85 is A84+1),
   freeze(A85, A86 is A85+1),
   freeze(A86, A87 is A86+1),
   freeze(A87, A88 is A87+1),
   freeze(A88, A89 is A88+1),
   freeze(A89, A90 is A89+1),
   freeze(A90, A91 is A90+1),
   freeze(A91, A92 is A91+1),
   freeze(A92, A93 is A92+1),
   freeze(A93, A94 is A93+1),
   freeze(A94, A95 is A94+1),
   freeze(A95, A96 is A95+1),
   freeze(A96, A97 is A96+1),
   freeze(A97, A98 is A97+1),
   freeze(A98, A99 is A98+1),
   freeze(A99, A100 is A99+1),
   freeze(A100, _A101 is A100+1).

freeze_dummy(A1, A101) :-
   call(A2 is A1+1),
   call(A3 is A2+1),
   call(A4 is A3+1),
   call(A5 is A4+1),
